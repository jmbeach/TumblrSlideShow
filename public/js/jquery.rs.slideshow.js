...
(function ($) {
    ...
    var methods = {
		...
		*/
		...
		nextSlide: function () {
            dataRetriever.slideNumber++;
            //updateCaptionText();
            // 4 is arbitrary. Get more photos before you run out
            if (dataRetriever.slideNumber == dataRetriever.totalPhotoCount - 4) {
                dataRetriever.getMorePhotos();
            }
		...
		*/
		...
		showSlide: function (slide) {
            ...
            var whenLoaded = function (img) {
                ...
                $(img).attr("data-adaptive-background", '1');
                ...
                var whenDimensions = function (width, height) {
                    ...
                    dataRetriever.scaleImage($($img),width,height);
                    ...
                    if (dataRetriever.previousSlideColor == null) {
                        //$slide.css('backgroundColor', 'white');
                        //dataRetriever.previousSlideColor = 'white';
                    }
                    else {
                        $slide.css('backgroundColor', dataRetriever.previousSlideColor);
                    }
                    $slide.append($img).css('display', 'none');
                    if (slide.caption && $("#cbShowCaption").is(":checked")) {
                ...
                // $(".rs-slideshow .slide-container img").centerImage('inside');
            };
